...
<div class="main_content_iner main_content_padding">
                                ...
                                <form action="{{ route('depositSelectOption') }}" method="post">
                                    <div class="single_totl_warp col-lg-12 pl-0">
                                        ...
                                        <div class="input-group mb-3 input-group-lg deposit_save_info">
                                            ...
                                            <input placeholder="{{ $symbol }}" name="deposit_amount"
                                                type="number" step="any" min="1"
                                                value="{{ !empty($amount) ? $amount : '' }}"
                                                class="primary_input col-md-6" required>

                                            <div class="input-group-prepend">
                                                <button type="submit" style="margin-bottom: 30px;"
                                                    class="theme_btn btn-sm  small_btn2   ">{{ __('payment.Save Info') }}
                                                </button>
                                ...
                                <div class="col-12">
                                    <div class="">
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="section__title3 mb_40">
                                                    <h3 class="mb-0">{{ __('common.Select') }}
                                                        {{ __('payment.Payment Method') }}</h3>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                                ...
                                                <div class="deposit_lists_wrapper mb-50">
                                                    @if (isset($methods))
                                                        @foreach ($methods as $key => $gateway)
                                                            @php
                                                                if (
                                                                    !paymentGateWayCredentialsEmptyCheck(
                                                                        $gateway->method,
                                                                    )
                                                                ) {
                                                                    continue;
                                                            ...
                                                            @endphp
                                                            <div
                                                                class="single_deposite {{ $gateway->method == 'Bank Payment' || $gateway->method == 'Bkash Payment' ? 'p-0 border-0' : '' }}">
                                                                            ...
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-md-12">
                                                                                            @include(
                                                                                                'mercadopago::partials._checkout',
                                                                                                compact(
                                                                                                    'total_amount',
                                                                                                    'payment_type'))
                                                                                        </div>
                                                                        ...
                                                                        <div class="deposite_button text-center">
                                                                            <form action="{{ route('depositSubmit') }}"
                                                                                ...
                                                                                <script src="https://checkout.razorpay.com/v1/checkout.js" data-key="{{ getPaymentEnv('RAZOR_KEY') }}"
                                                                                    ...
                                                                                    data-name="{{ Settings('site_title') }}" data-description="Cart Payment"
                                                                ...
                                                                @elseif($gateway->method == 'Authorize.Net')
                                                                    @includeIf('authorizenet::diposit_form', [
                                                                        'gateway' => $gateway,
                                                                        'amount' => $amount,
                                                                    ])
                                                                @elseif($gateway->method == 'Braintree')
                                                                    @includeIf('braintree::disposit', [
                                                                        'gateway' => $gateway,
                                                                        'amount' => $amount,
                                                                    ])
                                                                @elseif($gateway->method == 'Mollie')
                                                                    @includeIf('mollie::deposit', [
                                                                        'gateway' => $gateway,
                                                                        'amount' => $amount,
                                                                    ])
                                                                @elseif($gateway->method == 'Flutterwave')
                                                                    @includeIf('flutterwave::deposit', [
                                                                        'gateway' => $gateway,
                                                                        'amount' => $amount,
                                                                    ])
                                                                @elseif($gateway->method == 'Jazz Cash')
                                                                    @includeIf('jazzcash::deposit', [
                                                                        'gateway' => $gateway,
                                                                        'amount' => $amount,
                                                                    ])
                                                                @elseif($gateway->method == 'Coinbase')
                                                                    @includeIf('coinbase::deposit', [
                                                                        'gateway' => $gateway,
                                                                        'amount' => $amount,
                                                                    ])
                                                                ...
                                                                @elseif($gateway->method == 'Bkash Payment')
                                                                    <form class="w-100" action=""
                                                                        method="post">
                                                                        @csrf

                                                                        <a href="#" data-toggle="modal"
                                                                            data-target="#bkashModel"
                                                                            class="payment_btn_text2 w-100">
                                                                            {{ $gateway->method }}
                                                                        </a>
                                                                    </form>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-xl-6 col-md-6">
                                        ...
                                        <input type="text" required name="branch_name"
                                            class="primary_input4 mb_20" placeholder="Name of account owner"
                                ...
                                <div class="row mb-20">
                                    ...
                                    <div class="col-xl-6 col-md-6">
                                        ...
                                        <input type="text" required name="account_holder"
                                            class="primary_input4 mb_20" placeholder="Account Holder"
                                    ...
                                    <div class="col-xl-6 col-md-12">
                                        ...
                                        <select class="theme_select wide update-select-arrow" name="type" required
                                            ...
                                            <option value="Current Account"
                                                {{ (env('ACCOUNT_TYPE') ? env('ACCOUNT_TYPE') : '') == 'Current Account' ? 'selected' : '' }}>
                                                {{ __('payment.Current Account') }}

                                            </option>
                                            <option value="Savings Account"
                                                {{ (env('ACCOUNT_TYPE') ? env('ACCOUNT_TYPE') : '') == 'Savings Account' ? 'selected' : '' }}>
                                                {{ __('payment.Savings Account') }}
                                            </option>
                                            <option value="Salary Account"
                                                {{ (env('ACCOUNT_TYPE') ? env('ACCOUNT_TYPE') : '') == 'Salary Account' ? 'selected' : '' }}>
                                                {{ __('payment.Salary Account') }}

                                            </option>
                                            <option value="Fixed Deposit"
                                                {{ (env('ACCOUNT_TYPE') ? env('ACCOUNT_TYPE') : '') == 'Fixed Deposit' ? 'selected' : '' }}>
                            ...
                            <div class="col-md-6">
                                <div class="modal-header pl-0">
                                    <h5 class="modal-title" id="exampleModalLabel">
                                        {{ __('common.Bank Account Info') }}</h5>
                                </div>
                                <fieldset class="mt-3">
    ...
    <div class="modal fade " id="bkashModel" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form name="bank_payment" enctype="multipart/form-data" action="{{ route('depositSubmit') }} "
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="modal-header pl-0">
                                    <h5 class="modal-title" id="">{{ __('Bkash Payment') }} </h5>
                                </div>
                                <input type="hidden" name="method" value="Bkash Payment">

                                <div class="row mb-20">
                                    <div class="col-xl-12 col-md-12">
                                        <label for="name" class="mb-2">@lang('Bkash TrxID')
                                            <span>*</span></label>
                                        <input type="text" required class="primary_input4 mb_20"
                                            placeholder="Bkash TrxID" name="bkash_trxid"
                                            value="{{ @old('bkash_trxid') }}">
                                        <span class="invalid-feedback" role="alert" id="bkash_trxid"></span>
                                    </div>
                                    <div class="col-xl-12 col-md-12">
                                        <label for="name" class="mb-2">@lang('Bkash From Number')
                                            <span>*</span></label>
                                        <input type="text" required name="bkash_from_number"
                                            class="primary_input4 mb_20" placeholder="Bkash From Number"
                                            value="{{ @old('bkash_from_number') }}">
                                        <span class="invalid-feedback" role="alert" id="bkash_from_number"></span>
                                    </div>
                                    <input type="hidden" name="deposit_amount" value="{{ $amount }}">
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="modal-header pl-0">
                                    <h5 class="modal-title" id="exampleModalLabel">
                                        {{ __('Bkash Account Info') }}</h5>
                                </div>
                                <fieldset class="mt-3">
                                    <table class="table table-bordered">
                                        <tr>
                                            <td>@lang('Account Number')</td>
                                            <td>{{ getPaymentEnv('B_ACCOUNT_NUMBER') }}</td>
                                        </tr>
                                        <tr>
                                            <td>@lang('Account Type')</td>
                                            <td>{{ getPaymentEnv('B_ACCOUNT_TYPE') }}</td>
                                        </tr>
                                        <tr>
                                            <td colspan="2">{{ getPaymentEnv('B_ACCOUNT_MESSAGE') }}</td>
                                        </tr>
                                    </table>
                                </fieldset>
                            </div>

            ...
            <div class="row">
                                            ...
                                            <div class="primary_input mb-25">
                                                <div class="input-effect">
                                                    <input type="checkbox" id="method_{{ $payment_method->id }}"
                                                        ...
                                                        name="gateways[]" value="{{ $payment_method->id }}"
                ...
                <div class="col-lg-9 ">
                    <div class="payment_getway_tab ">
                        ...
                        <ul class="nav nav-tabs no-bottom-border  mt-sm-md-20 mb-10" style="margin-left:0" role="tablist">
                                ...
                                @if ($payment_method->method == 'Instamojo')
                                    <li class="nav-item m-1">
                                        <a class="nav-link  {{ $Key == 0 ? 'active' : '' }} "
                                            ...
                                            data-toggle="tab">{{ @$payment_method->method }}</a>
                                    </li>
                                @else
                                    <li class="nav-item m-1">
                                        <a class="nav-link  {{ $Key == 0 ? 'active' : '' }} "
                            ...
                            <div role="tabpanel" class="tab-pane fade  {{ $key == 0 ? 'active' : '' }}  show "
                                ...
                                @if (permissionCheck('paymentmethodsetting.payment_method_setting_update'))
                                    <form class="form-horizontal"
                                        action="{{ route('paymentmethodsetting.update_payment_gateway') }}" method="POST"
                                ...
                                <div class="white-box">
                                    ...
                                    <div class="col-md-12 ">
                                                        ...
                                                        <div class="col-lg-4 mb-25">
                                                            <div class="input-effect">
                                                                ...
                                                                <input
                                                                    ...
                                                                    id="instamojo_api_auth" required autocomplete="off"
                                                                ...
                                                                <div class="">
                                                                    <div class="text-left float-left">
                                                                        <label class="primary_checkbox d-flex mr-12"
                                                                            ...
                                                                            <input type="radio" name="midtrans_env"
                                                                ...
                                                                <div class="input-effect">
                                                                    <div class="text-left float-left">
                                                                        ...
                                                                        <label class="primary_checkbox d-flex mr-12"
                                                                            ...
                                                                            <input type="radio" name="midtrans_sanitiz"
                                                                ...
                                                                <div class="input-effect">
                                                                    <div class="text-left float-left">
                                                                        <label class="primary_checkbox d-flex mr-12"
                                                                            ...
                                                                            <input type="radio" name="midtrans_3ds"
                                                ...
                                                <div class="col-md-12">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6 mb-25">
                                                            <div class="input-effect">
                                                                <input class="primary-input form-control" type="text"
                                                                    name="payeer_marchant" id="payeer_marchant" required
                                                                    autocomplete="off"
                                                        ...
                                                        <div class="col-lg-6 mb-25">
                                                            <div class="input-effect">
                                                                <input class="primary-input form-control" type="text"
                                                                    name="payeer_key" id="payeer_key" required
                                                                    autocomplete="off"
                                                        ...
                                                        <div class="col-lg-4 mb-25">
                                                            <div class="input-effect">
                                                                ...
                                                                <input
                                                                    ...
                                                                    type="text" name="ssl_store_id" id="ssl_store_id"
                                                                    required autocomplete="off"
                                                ...
                                                <div class="col-md-12">
                                                    <div class="row">
                                                        <div class="col-lg-4 mb-25">
                                                            <div class="input-effect">
                                                                <input class="primary-input form-control" type="text"
                                                                    name="pesapal_client_id" id="pesapal_client_id"
                                                                    required autocomplete="off"
                                                            ...
                                                            <div class="input-effect">
                                                                <div class="">
                                                                    <div class="text-left float-left">
                                                                        <label class="primary_checkbox d-flex mr-12"
                                                                            for="mode_check_{{ $payment_method->id }}">
                                                                            <input type="radio" name="pesapal_mode"
                                                ...
                                                <div class="col-md-12">
                                                    <div class="row">
                                                        <div class="col-lg-6 mb-25">
                                                            <div class="input-effect">
                                                                <input class="primary-input form-control" type="text"
                                                                    name="mobilpay_merchant_id" id="mobilpay_merchant_id"
                                                                    required autocomplete="off"
                                                                ...
                                                                <div class="">
                                                                    <div class="text-left float-left">
                                                                        <label class="primary_checkbox d-flex mr-12"
                                                                            ...
                                                                            <input type="radio" name="mobilpay_mode"
                                                ...
                                                <div class="col-md-12">
                                                    <div class="row">
                                                        <div class="col-lg-4 mb-25">
                                                            <div class="input-effect">
                                                                <input class="primary-input form-control" type="text"
                                                                    name="paypal_client_id" id="paypal_client_id" required
                                                                    autocomplete="off"
                                            ...
                                            <div class="row mb-25">
                                                <div class="col-md-12">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6 mb-25">
                                                            <div class="input-effect">
                                                                <input required class="primary-input form-control "
                                                                    type="text" name="client_secret" id="secret_key"
                                                                    autocomplete="off"
                                                ...
                                                <div class="col-md-12">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6 mb-25">
                                                            <div class="input-effect">
                                                                <input required class="primary-input form-control "
                                                                    type="text" name="paystack_key" id="razor_key"
                                                                    autocomplete="off"
                                                ...
                                                <div class="col-md-12">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6 mb-25">
                                                            <div class="input-effect">
                                                                <input required class="primary-input form-control "
                                                                    type="text" name="razor_key" id="razor_key"
                                                                    autocomplete="off"
                                                        ...
                                                        <div class="col-lg-6 mb-25">
                                                            <div class="input-effect">
                                                                <input required class="primary-input form-control"
                                                                    type="text" name="razor_secret" id="razor_secret"
                                                                    autocomplete="off"
                                                ...
                                                <div class="col-md-12">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6 mb-25">
                                                            <div class="input-effect">
                                                                <input required class="primary-input form-control"
                                                                    type="text" name="access_token" id="access_token"
                                                                    autocomplete="off"
                                                ...
                                                <div class="col-md-12">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-6 mb-25">
                                                            <div class="input-effect">
                                                                <input required class="primary-input form-control "
                                                                    type="text" name="paytm_channel" id="razor_key"
                                                                    autocomplete="off"
                                                        ...
                                                        <div class="col-lg-6 mb-25">
                                                            <div class="input-effect">
                                                                <input required class="primary-input form-control"
                                                                    type="text" name="industry_type" id="razor_secret"
                                                                    autocomplete="off"
                                                ...
                                                <div class="col-md-12">
                                                    <div class="row">
                                                        <div class="col-lg-4 mb-25">
                                                            <div class="input-effect">
                                                                <input class="primary-input form-control" type="text"
                                                                    name="bkash_app_key" id="bkash_app_key" required
                                                                    autocomplete="off"
                                                        ...
                                                        <div class="col-lg-4 mb-25">
                                                            <div class="input-effect">
                                                                <input class="primary-input form-control" type="text"
                                                                    name="bkash_username" id="bkash_username" required
                                                                    autocomplete="off"
                                                            ...
                                                            <div class="input-effect">
                                                                <div class="">
                                                                    <div class="text-left float-left">
                                                                        <label class="primary_checkbox d-flex mr-12"
                                                                            for="mode_check_{{ $payment_method->id }}">
                                                                            <input type="radio" name="bkash_mode"
                                                ...
                                                <div class="col-md-12">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-4 mb-25">
                                                            <div class="input-effect">
                                                                <input required class="primary-input form-control"
                                                                    type="text" name="branch_name" id="branch_name"
                                                                    autocomplete="off"
                                        ...
                                        @elseif($payment_method->method == 'Bkash Payment')
                                            <div class="row mb-25">
                                                <div class="col-md-12">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-4 mb-25">
                                                            <div class="input-effect">
                                                                <input required class="primary-input form-control "
                                                                    type="text" name="b_account_message" id="b_account_message"
                                                                    autocomplete="off"
                                                                    value="{{ getPaymentEnv('B_ACCOUNT_MESSAGE') ? getPaymentEnv('B_ACCOUNT_MESSAGE') : '' }}">
                                                                <label>{{ __('Bkash Acount Message') }}
                                                                    <span></span> </label>
                                                                <span class="focus-border"></span>
                                                                <span class="modal_input_validation red_alert"></span>
                                                            </div>
                                                        ...
                                                        <div class="col-lg-4 mb-25">
                                                            <div class="input-effect">
                                                                <input required class="primary-input form-control"
                                                                    type="text" name="b_account_type" id="b_account_type"
                                                                    autocomplete="off"
                                                                    value="{{ getPaymentEnv('B_ACCOUNT_TYPE') ? getPaymentEnv('B_ACCOUNT_TYPE') : '' }}">
                                                                <label>{{ __('Bkash Account Type') }}
                                                                    <span></span> </label>
                                                                <span class="focus-border"></span>
                                                                <span class="modal_input_validation red_alert"></span>
                                                            </div>
                                                        ...
                                                        <div class="col-lg-6 mb-25">
                                                            <div class="input-effect">
                                                                <input required class="primary-input form-control "
                                                                    type="text" name="b_account_number"
                                                                    id="b_account_number" autocomplete="off"
                                                                    value="{{ getPaymentEnv('B_ACCOUNT_NUMBER') ? getPaymentEnv('B_ACCOUNT_NUMBER') : '' }}">
                                                                <label>{{ __('Bkash Account Number') }}
                                                                    <span></span> </label>
                                                                <span class="focus-border"></span>
                                                                <span class="modal_input_validation red_alert"></span>
                                                            </div>
                                                            ...
                                                            <div class="input-effect">
                                                                <div class="">
                                                                    ...
                                                                    <div class="text-left float-left">
                                                                        <label class="primary_checkbox d-flex mr-12"
                                                                            for="mode_check_{{ $payment_method->id }}">
                                                                            <input type="radio" name="razerms_mode"
                                            ...
                                            <div class="row mb-25">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="row mt-2 mb-2">
                                                        <div class="col-lg-6 mb-25">
                                                            <div class='input-effect'>
                                                                <label for=""> {{ __('setting.Auto Redirect') }}
                                                ...
                                                <div class="col-lg-12">
                                                    <div class='input-effect mb-25'>
                                                        ...
                                                        <input type="text" id='{{ $payment_method->id }}'
                                                            ...
                                                            class="primary-input form-control" name="MOLLIE_SECRET_KEY">
                                                        <label for="{{ $payment_method->id }}">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class='input-effect mb-25'>
                                                        ...
                                                        <input type="text" id='{{ $payment_method->id }}'
                                                            ...
                                                            class="primary-input form-control" name="FLW_PUBLIC_KEY">
                                                        <label for="{{ $payment_method->id }}">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class='input-effect mb-25'>
                                                        ...
                                                        <input type="text" id='{{ $payment_method->id }}'
                                                            ...
                                                            class="primary-input form-control" name="FLW_SECRET_KEY">
                                                        <label for="{{ $payment_method->id }}">
                                                            <span>{{ trans('setting.Secret Key') }}</span>
                                                        </label>
                                                    </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class='input-effect mb-25'>
                                                        ...
                                                        <input type="text" id='{{ $payment_method->id }}'
                                                            ...
                                                            class="primary-input form-control" name="FLW_SECRET_HASH">
                                                        <label for="{{ $payment_method->id }}">
                                                                ...
                                                                <div class="">
                                                                    <div class="text-left float-left">
                                                                        <label class="primary_checkbox d-flex mr-12"
                                                                            ...
                                                                            <input type="radio" name="FLW_ENVIRONMENT"
                                                ...
                                                <div class="col-lg-6 col-md-6 col-xs-12 col-sm-12">
                                                    <div class='input-effect mb-25'>
                                                        ...
                                                        <input type="text" id='{{ $payment_method->id }}'
                                                            ...
                                                            class="primary-input form-control" name="COINBASE_API_KEY">
                                                        <label for="{{ $payment_method->id }}">
                                                ...
                                                <div class="col-lg-6 col-md-6">
                                                    <div class='input-effect mb-25'>
                                                        ...
                                                        <input type="text" id='{{ $payment_method->id }}'
                                                            ...
                                                            class="primary-input form-control" name="CCA_KEY">
                                                        <label for="{{ $payment_method->id }}">
                                                ...
                                                <div class="col-lg-6 col-md-6">
                                                    <div class='input-effect mb-25'>
                                                        ...
                                                        <input type="text" id='{{ $payment_method->id }}'
                                                            ...
                                                            class="primary-input form-control" name="CCA_ACCESS_CODE">
                                                        <label for="{{ $payment_method->id }}">
                                                ...
                                                <div class="col-lg-6 col-md-6">
                                                    <div class='input-effect mb-25'>
                                                        ...
                                                        <input type="text" id='{{ $payment_method->id }}'
                                                            ...
                                                            class="primary-input form-control" name="CCA_MERCHANT_ID">
                                                        <label for="{{ $payment_method->id }}">
                                                            <span>{{ _trans('common.Merchant ID') }}</span>
                                                        </label>
                                                    </div>
                                                ...
                                                <div class="col-lg-4 col-md-4">
                                                    <div class='input-effect mb-25'>
                                                        ...
                                                        <input type="text" id='{{ $payment_method->id }}'
                                                            ...
                                                            class="primary-input form-control" name="Tranzak_APP_ID">
                                                        <label for="{{ $payment_method->id }}">
                                                ...
                                                <div class="col-lg-4 col-md-4">
                                                    <div class='input-effect mb-25'>
                                                        ...
                                                        <input type="text" id='{{ $payment_method->id }}'
                                                            ...
                                                            class="primary-input form-control" name="Tranzak_API_KEY">
                                                        <label for="{{ $payment_method->id }}">
                                        ...
                                        @if (
                                            $payment_method->method != 'Bank Payment' &&
                                                $payment_method->method != 'Bkash Payment' &&
                                                $payment_method->method != 'Offline Payment' &&
                                            ...
                                            <div class="row imageBox mt-4">
                                                ...
                                                <div class="col-xl-6">
                                                    <img class="  p-3 preview" style="max-height: 100px;max-width: 100%"
                                                        src="{{ asset($payment_method->logo) }}" alt="">
                                                </div>
                                            </div>
                                        @endif

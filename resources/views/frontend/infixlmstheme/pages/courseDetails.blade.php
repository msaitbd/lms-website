...
@section('css')
    ...
    <link href="{{asset('frontend/infixlmstheme/css/videopopup.css')}}{{assetVersion()}}" rel="stylesheet"/>
    <link href="{{asset('frontend/infixlmstheme/css/video.popup.css')}}{{assetVersion()}}" rel="stylesheet"/>
